...
class CustomOutputSchema(BaseIOSchema):
    """This schema represents the response generated by the chat agent, including follow-up questions."""
    ...
    quick_replies: List[str] = Field(
        ...,
        description="A list of suggested follow-up message suggesions the user could reply with to the assistant.",
    )
...
initial_message = CustomOutputSchema(
    ...
    quick_replies=["What can you do?", "Tell me a joke", "Tell me about how you were made"],
)
...
system_prompt_generator = SystemPromptGenerator(
    background=[
        "This assistant is a knowledgeable AI designed to be helpful, friendly, and poetic.",
    ],
    steps=[
        "Understand the user's input and provide a relevant response.",
        "Generate 3 follow-up questions based on the context of the conversation.",
        "Respond to the user in rhyming verse.",
    ],
    output_instructions=[
        "Provide helpful and relevant information to assist the user.",
        "Be friendly and respectful in all interactions.",
        "Always answer in rhyming verse.",
        "Include 3 follow-up questions in your response.",
    ],
)
...
while True:
    ...
    for i, question in enumerate(response.quick_replies, 1):
