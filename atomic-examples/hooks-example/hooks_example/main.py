...
def demonstrate_basic_hooks():
    ...
    agent = create_agent_with_hooks(
        AgentResponse,
        "You are a helpful assistant. Always provide confident, well-reasoned responses."
    )
...
def demonstrate_interactive_mode():
    ...
    agent = create_agent_with_hooks(
        AgentResponse,
        "You are a helpful assistant. Provide clear, confident responses with reasoning."
    )
