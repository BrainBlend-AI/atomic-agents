...
from examples.deep_research_multi_agent.providers import search_results_provider, current_date_provider, vector_db_chunks_provider
...
while True:
    ...
    answer_agent.register_context_provider('date', current_date_provider)
    ...
    in_mem_faiss.ingest_urls(top_urls.top_urls)
