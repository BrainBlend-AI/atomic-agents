...
def analyze_navigation_patterns(html_content: str, url: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "enhanced_navigation": {
            ...
            "mobile_navigation": {
                "has_hamburger": (
                    enhanced_analysis.mobile_navigation.hamburger_selector is not None
                    if enhanced_analysis.mobile_navigation
                    else False
                ),
                "slide_direction": (
                    enhanced_analysis.mobile_navigation.slide_direction if enhanced_analysis.mobile_navigation else None
                ),
                "has_overlay": (
                    enhanced_analysis.mobile_navigation.overlay_selector is not None
                    if enhanced_analysis.mobile_navigation
                    else False
                ),
                "has_accordion": (
                    enhanced_analysis.mobile_navigation.has_accordion if enhanced_analysis.mobile_navigation else False
                ),
            },
            "pagination": {
                "type": (
                    enhanced_analysis.advanced_pagination.pagination_type if enhanced_analysis.advanced_pagination else None
                ),
                "current_page": (
                    enhanced_analysis.advanced_pagination.current_page if enhanced_analysis.advanced_pagination else None
                ),
                "total_pages": (
                    enhanced_analysis.advanced_pagination.total_pages if enhanced_analysis.advanced_pagination else None
                ),
                "has_page_size_selector": (
                    enhanced_analysis.advanced_pagination.has_page_size_selector
            ...
            "contextual_navigation": {
                "has_tags": (
                    enhanced_analysis.contextual_navigation.tags_selector is not None
                    if enhanced_analysis.contextual_navigation
                    else False
                ),
                "has_categories": (
                    enhanced_analysis.contextual_navigation.categories_selector is not None
                    if enhanced_analysis.contextual_navigation
                    else False
                ),
                "related_links_count": (
                    len(enhanced_analysis.contextual_navigation.related_links)
                    if enhanced_analysis.contextual_navigation
                    else 0
                ),
                "social_sharing_count": (
                    len(enhanced_analysis.contextual_navigation.social_sharing)
                    if enhanced_analysis.contextual_navigation
                    else 0
                ),
            },
            ...
            "filter_navigation": {
                key: len(value) if isinstance(value, list) else 1 for key, value in enhanced_analysis.filter_navigation.items()
            },
