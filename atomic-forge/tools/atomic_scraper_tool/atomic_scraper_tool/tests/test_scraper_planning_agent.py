...
class TestAtomicScraperAgentOutputSchema:
    ...
    def test_confidence_validation(self):
        ...
        valid_output = AtomicScraperAgentOutputSchema(
            scraping_plan="test", strategy={}, schema_recipe={}, reasoning="test", confidence=0.75
        )
...
class TestAtomicScraperPlanningAgent:
    ...
    def setup_method(self):
        ...
        # Create agent config
        self.config = BaseAgentConfig(client=self.mock_client, model="gpt-4o-mini")
    ...
    def test_agent_with_custom_model(self):
        ...
        custom_config = BaseAgentConfig(client=self.mock_client, model="gpt-4")
...
class TestRequestParsingAndStrategyCoordination:
    ...
    def test_generate_scraping_plan(self):
        ...
        schema_recipe = SchemaRecipe(name="test_schema", description="Test schema", fields=fields)
    ...
    @pytest.mark.parametrize(
        "user_request,expected_content_type",
        [
    ...
    @pytest.mark.parametrize(
        "user_request,expected_data_types",
        [
