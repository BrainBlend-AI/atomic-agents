...
class TestReasoningGeneration:
    ...
    def test_generate_reasoning_with_website_error(self):
        ...
        reasoning = self.agent._generate_reasoning(
            error_analysis, self.test_strategy, self.test_schema_recipe, self.test_parsed_request
        )
    ...
    def test_get_selector_reasoning(self):
        ...
        reasons = self.agent._get_selector_reasoning(self.test_strategy, self.test_parsed_request)
    ...
    def test_apply_confidence_modifiers(self):
        ...
        modified_confidence = self.agent._apply_confidence_modifiers(
            base_confidence, self.mock_analysis, self.test_strategy, self.test_schema_recipe
        )
    ...
    def test_confidence_with_high_risk_scenario(self):
        ...
        confidence = self.agent._calculate_confidence(error_analysis, risky_strategy, large_schema)
    ...
    def test_reasoning_with_minimal_data(self):
        ...
        minimal_strategy = ScrapingStrategy(scrape_type="list", target_selectors=["div"])
...
class TestConfidenceScoring:
    ...
    def test_confidence_worst_scenario(self):
        ...
        confidence = self.agent._calculate_confidence(bad_analysis, bad_strategy, bad_schema)
