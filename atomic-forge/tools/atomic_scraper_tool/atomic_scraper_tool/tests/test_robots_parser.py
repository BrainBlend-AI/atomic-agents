...
from atomic_scraper_tool.compliance.robots_parser import RobotsParser, RobotsTxtInfo, RobotsTxtRule
...
"""
        ...
        robots_info = self.parser._parse_robots_content("https://example.com/robots.txt", content)
...
class TestRobotsTxtModels:
    ...
    def test_robots_txt_rule_model(self):
        ...
        rule = RobotsTxtRule(user_agent="TestBot", directive="Disallow", path="/private/")
    ...
    def test_robots_txt_info_model(self):
        ...
        info = RobotsTxtInfo(
            ...
            rules=[RobotsTxtRule(user_agent="*", directive="Disallow", path="/")],
        )
    ...
    def test_robots_txt_info_defaults(self):
        ...
        info = RobotsTxtInfo(url="https://example.com/robots.txt", content="")
