...
class StrategyGenerator:
    ...
    def _determine_scrape_type(self, analysis: WebsiteStructureAnalysis, context: StrategyContext) -> str:
        ...
        content_scores = {"list": 0.0, "detail": 0.0, "search": 0.0, "sitemap": 0.0}
    ...
    def _generate_target_selectors(
        self, analysis: WebsiteStructureAnalysis, context: StrategyContext, scrape_type: str
    ) -> List[str]:
    ...
    def _generate_fallback_selectors(self, analysis: WebsiteStructureAnalysis, scrape_type: str) -> List[str]:
        ...
        if scrape_type == "list":
            ...
            fallback_selectors = ["nav a", 'div[class*="nav"] a', 'div[class*="menu"] a', "ul a", "ol a"]
            ...
            for i, selector in enumerate(candidates):
                ...
                recommendations.append(
                    SelectorRecommendation(
                        selector=selector, confidence=confidence, reasoning=reasoning, fallback_selectors=fallbacks
                    )
                )
