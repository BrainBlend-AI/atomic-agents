...
class WebsiteAnalyzer:
    ...
    def __init__(self):
        ...
        self.content_type_patterns = {
            "list": [r"ul\s*>\s*li", r"ol\s*>\s*li", r"\.list", r"\.items", r'\[class\*="item"\]', r'\[class\*="list"\]'],
            "article": [r"article", r"\.article", r"\.post", r"\.blog", r'\[class\*="article"\]', r'\[class\*="post"\]'],
            "product": [r"\.product", r"\.item", r'\[class\*="product"\]', r"\[data-product\]", r"\.price", r"\.buy"],
            "navigation": [r"nav", r"\.nav", r"\.menu", r"\.navigation", r'\[role="navigation"\]'],
            "pagination": [r"\.pagination", r"\.pager", r"\.page-numbers", r'\[class\*="page"\]'],
        }
