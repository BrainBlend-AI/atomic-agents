...
class SchemaRecipeGenerator:
    ...
    def _calculate_quality_weights(
        self, field_definitions: Dict[str, FieldDefinition], context: SchemaGenerationContext
    ) -> Dict[str, float]:
    ...
    def _generate_schema_description(
        self, context: SchemaGenerationContext, field_definitions: Dict[str, FieldDefinition]
    ) -> str:
    ...
    def _find_better_selector(
        self, field_name: str, field_def: FieldDefinition, analysis: WebsiteStructureAnalysis
    ) -> Optional[str]:
